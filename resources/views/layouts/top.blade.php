    ...
    <div class="header-right">
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                ...
                <img src="{{ Auth::user()->copy_of_id ? Auth::user()->copy_of_id : asset('image/!logged-user.jpg') }}" alt="Joseph Doe" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
                </figure>
